...
function Header() {
  ...
  return <header className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur">
    <div className="section-shell flex h-20 items-center justify-between gap-5">
      ...
      <div className="ml-auto flex items-center gap-3 sm:gap-4"><img src={bincomLogo.url} alt="Bincom Dev Center" width={768} height={768} className="h-11 w-12 border-l border-border object-contain pl-3 sm:h-14 sm:w-20 sm:pl-4"/><div className="hidden sm:block"><ApplyButton label="Register Now" /></div></div>
...
function Index() {
  return <div className="overflow-hidden bg-background text-foreground"><Header /><main>
    <section id="overview" className="grid-paper border-b border-border"><div className="section-shell grid min-h-[calc(100vh-8rem)] items-center gap-12 py-14 lg:grid-cols-[1.05fr_.95fr] lg:py-16">
